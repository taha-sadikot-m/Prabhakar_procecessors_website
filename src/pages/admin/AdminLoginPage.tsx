  ...
  return (
    <main className="relative flex min-h-svh items-center justify-center bg-cream-light px-5 py-12">
      <div
        ...
        style={{
          backgroundImage:
            'radial-gradient(ellipse 80% 50% at 50% -10%, rgba(103,68,56,0.14), transparent), radial-gradient(ellipse 45% 35% at 85% 80%, rgba(247,148,29,0.07), transparent)',
        }}
        aria-hidden="true"
      />
      <form
        onSubmit={onSubmit}
        className="relative w-full max-w-md overflow-hidden rounded-2xl border border-ink/10 bg-cream px-6 py-8 shadow-[0_2px_4px_rgba(45,27,14,0.04),0_16px_40px_rgba(45,27,14,0.1)] md:px-8 md:py-10"
      >
        <span
          className="absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-mahogany via-saffron/70 to-transparent"
          aria-hidden="true"
        />
